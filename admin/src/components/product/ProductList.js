                            ...
                            return <div className="row my-5" key={index}>
                                <div className={item.id % 2 ? 'col-lg-6' : 'col-lg-6 order-last'}>
                                    <div className="intro-left">
                                        ...
                                        <a href="# " className="primary-btn">Book</a>
                                    </div>
                                </div>
                                <div className=" image slider col-lg-6">
                                    <div className="intro- room-section">
                                        <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                                            ...
                                            <a className="carousel-control-prev" href="#carouselExampleControls<?php echo $cid; ?>" role="button" data-slide="prev">
                                                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                                                <span className="sr-only">Previous</span>
                                            </a>
                                            <a className="carousel-control-next" href="#carouselExampleControls<?php echo $cid; ?>" role="button" data-slide="next">
