            ...
            Cell: ({ row }) => (
                <>
                    <button
                        ...
                        onClick={() => dispatch(removeOurteam(row.original.id))}
                    >
                        Remove
                    </button>
                    <button
        ...
        <>
            <div className="container-fluid mt-5">
                ...
                {teamData?.data?.length > 0 && (
                    <AdminTable tableHeaders={tableHeaders} tableData={teamData.data} />
                )}
            </div>
            ...
            {showModal && selectedTeamMember && (
                <div
                    ...
                    tabIndex="-1"
                    role="dialog"
                    aria-labelledby="editTeamMemberModal"
                    aria-hidden="true"
                >
                    <div className="modal-dialog modal-dialog-centered" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>Edit details for: <strong>{selectedTeamMember.name}</strong></p>
