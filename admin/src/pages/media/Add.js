...
import { addMedia } from 'slice/mediaSlice';
...
const Add = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            dispatch(addMedia(formDataToSend))
    ...
    return (
        <>
            ...
            <div className='mainheadig mx-4'>
                <h4 className='text-white font-weight-bold '>Add Media</h4>
            </div>
                <form onSubmit={handleSubmit}>
                    <div className='row mx-4'>
                        <div className='col-sm-12 mt-2'>
                            <label htmlFor='productName' className='adminlables'>Title</label>
                    ...
                    <div className='mt-4 text-right mx-5'>
                        <button className='btn addbtn btn-lg' disabled={loading}>Add Media</button>
                    </div>
                </form>
            </div>
        </>
