...
const Order = () => {
    ...
    return (
        <>
                    ...
                    <div className="row">
                        <div className=" mt-5 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <div className="page-section mt-5">
                                <h1 className="page-title" onClick={handleDecrypt}>Food Menu</h1>
                            </div>
                        </div>
                    </div>
                    <div className="row mt-4">
                        <div className="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb40">
                            <div className="menu-block">
                                <h3 className="menu-title my-3" onClick={handleEncrypt}>Starter</h3>
                                oooo {decryptedId} 
                                        ...
                                        data.map((item, index) => {
                                            return <div className="row">
                                                <div className="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div className="dish-img"><a href="#"><img src={item?.url} alt="" className="img-circle" /></a></div>
                                                </div>
                                                <div className="col-lg-7 col-md-8 col-sm-8 col-xs-12">
                                                    <div className="dish-content">
                                                        <h5 className="dish-title"><a href="#">{item?.name}</a></h5>
                                                ...
                                                <div className='col-sm-2'>
                                                    <button className='btn btn-success' onClick={() => dispatch(addOrder(item))}>+</button>
                                                </div>
                                            </div>
                                        })
                                        : "No Dish Found"}
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-xs-12 mb40">
                            <div className="menu-block">
                                ...
                                <div className="menu-content">
                                    <div className="row">
                                        <div className="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            <div className="dish-img"><a href="#"><img src="http://via.placeholder.com/70x70" alt="" className="img-circle" /></a></div>
                                        </div>
                                        <div className="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                            <div className="dish-content">
                                                <h5 className="dish-title"><a href="#">Minestrone</a></h5>
                                ...
                                <div className="menu-content">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                            <div className="dish-content">
                                                <h5 className="dish-title"><a href="#">Tomato soup</a></h5>
                                ...
                                <div className="menu-content">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                            <div className="dish-content">
                                                <h5 className="dish-title"><a href="#">Cream of broccoli</a> </h5>
                            ...
                            <div className="menu-block">
                                ...
                                <div className="menu-content">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                            <div className="dish-content">
                                                <h5 className="dish-title"><a href="#">Biryani</a></h5>
                                                <span className="dish-meta"> Onion  /  Tomato</span>
                                                <div className="dish-price">
                                                    <p>$14</p>
                                                </div>
                                ...
                                <div className="menu-content">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                            <div className="dish-content">
                                                <h5 className="dish-title"><a href="#">Paneer Butter Masala</a></h5>
                                                <span className="dish-meta">Aloo Masala  /  Aloo Palak
                                                </span>
                                                <div className="dish-price">
                                                    <p>$11</p>
                                                </div>
                                ...
                                <div className="menu-content">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                            <div className="dish-content">
                                                <h5 className="dish-title"><a href="#">Chole Bhature</a> </h5>
            ...
            {orderData.length && <div className="carditemdata bg-danger text-center p-2">
                <a href="#" className="text-white" onClick={handleClick}>CHECKOUT - {orderData.length} Items</a>
            </div>}
        </>
    )
}
