                ...
                <form onSubmit={handleSubmit}>
                    <div className='row'>
                        ...
                        <div className='col-sm-12 mt-2'>
                            ...
                            <input type='text' id='mobile' name='mobile' defaultValue={formData.mobile} className='form-control' onChange={handleChange} />
                        </div>
                        <div className='col-sm-12 mt-2'>
                            <label htmlFor='address'>Address</label>
                            <input type='text' id='address' name='address' defaultValue={formData.address} className='form-control' onChange={handleChange} />
                        </div>
                    </div>
                    <div className='mt-4 text-right mx-4'>
                        <button className='btn btn-lg addbtn' disabled={loading}>Add User</button>
                    </div>
                </form>
            </div>
        </>
