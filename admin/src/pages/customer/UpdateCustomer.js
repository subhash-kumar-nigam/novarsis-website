            ...
            <div className='container card my-5'>
                ...
                <div className='row'>
                    ...
                    <div className='col-sm-6 mt-2'>
                        ...
                        <input type='text' id='productName' name='mobile' defaultValue={formData.mobile} className='form-control' onChange={handleChange} />
                    </div>
                    <div className='col-sm-12 mt-2'>
                        <label htmlFor='productName'>Customer Address</label>
                        <input type='text' id='productName' name='address' defaultValue={formData.address} className='form-control' onChange={handleChange} />
                    </div>
                </div>
                <div className='mt-3 text-right'>
                    <button className='btn btn-success' disabled={loading}>Update Banner</button>
                </div>
                </form>
            </div>
        </>
