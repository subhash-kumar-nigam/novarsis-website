        ...
        <div className='mainheadig'>
                ...
                <div className='row p-3'>
                    ...
                    <div className='col-sm-4 mt-2'>
                        ...
                        <input type='text' id='productName' name='sprice' defaultValue={formData.sprice} className='form-control' onChange={handleChange} />
                    </div>
                    <div className='col-sm-4 mt-2'>
                        <label htmlFor='productName'>Product Size</label>
                        <input type='text' id='productName' name='unit' defaultValue={formData.unit} className='form-control' onChange={handleChange}  />
                    </div>
                    ...
                    <div className='col-sm-6 mt-2'>
                        ...
                        <input type='text' id='productName' name='quantity' defaultValue={formData.quantity} className='form-control' onChange={handleChange} />
                    </div>
                    <div className='col-sm-12 mt-2'>
                        <label htmlFor='productName'>Description</label>
                        <textarea rows={5} name='long_description'  defaultValue={formData.long_description} className='form-control' onChange={handleChange}></textarea>
                    </div>
                ...
                <div className='my-3 text-right'>
                    <button className='btn addbtn' disabled={loading}>Update Product</button>
                </div>
                </form>
            </div>
