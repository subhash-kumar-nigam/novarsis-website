...
const feesSlice = createSlice({
  ...
  reducers: {
    ...
    getFees: (state) => { state.loading = true; },
    getOneFee: (state) => { state.loading = true; },
    addFee: (state) => { state.loading = true; },
    updateFee: (state) => { state.loading = true; },
    removeFee: (state) => { state.loading = true; },
