...
export const { getOrderListDB, getOrderDeatilsDB, addOrderListDB, removeOrderListDB, updateOrderListDB, successOrderListDB, failedOrderListDB } = orderSliceDB.actions
