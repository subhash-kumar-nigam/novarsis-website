          ...
          <div className="col-lg-4 ">
            <div className="footer-item ">
              <div className="footer-logo ">
                <a href="# "><img src="img/Home/logo5.png " alt=" " /></a>
              </div>
          ...
          <div className="row pt-5 ">
            <div className="col-lg-12 ">
              <div className="small text-white text-center ">
                ...
                </script> All rights reserved <i className="fa fa-heart-o " aria-hidden={true}></i> by <a href="https://yashsoftsolution.com/ " target="_blank ">Yashsoft Solution</a>
              </div>
            </div>
          </div>
        </div>
