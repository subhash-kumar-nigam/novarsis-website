            ...
            <div id="wrapper">
                <ul className={toggled ? 'navbar-nav sidebar sidebar-dark toggled' : 'navbar-nav sidebar sidebar-dark accordion'} id="accordionSidebar">
                    ...
                    <li className={`nav-item ${lastSegment === 'contactus' ? 'active' : ''}`}>
                        ...
                        >
                            <div className="bg-white py-2 collapse-inner rounded">
                                <Link className="collapse-item text-dark" to="/contactus">Enquiry List</Link>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className={`nav-item ${lastSegment === 'apply' ? 'active' : ''}`}>
                        ...
                        <div
                            id="apply"
                            className={`collapse ${openMenu === 'apply' ? 'show' : ''}`}
                            aria-labelledby="headingTwo"
                        >
                            <div className="bg-white py-2 collapse-inner rounded">
                                <Link className="collapse-item text-dark" to="/apply">Job Apply List</Link>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className={`nav-item text-dark ${lastSegment === 'gallery' ? 'active' : ''}`}>
                        ...
                        >
                            <div className="bg-white py-2 collapse-inner rounded">
                                <Link className="collapse-item" to="/gallery/add">Add Our Gallery</Link>
                                <Link className="collapse-item" to="/gallery">Our Gallery List</Link>
                            </div>
                        </div>
                    </li>
...
<li className={`nav-item text-dark ${lastSegment === 'blog' ? 'active' : ''}`}>
  ...
  <div
    id="blog"
    className={`collapse ${openMenu === 'blog' ? 'show' : ''}`}
    aria-labelledby="headingBlog"
  >
    <div className="bg-white py-2 collapse-inner rounded">
    <Link className="collapse-item" to="/blogs/add">Add Blog</Link>
<Link className="collapse-item" to="/blogs/list">Blog List</Link>
    </div>
  </div>
</li>
  ...
  <div
    id="career"
    className={`collapse ${openMenu === 'career' ? 'show' : ''}`}
  ...
  <div
    id="service"
    className={`collapse ${openMenu === 'service' ? 'show' : ''}`}
      ...
      <Link className="collapse-item" to="/services/list">
        Service List
                    ...
                    <li className={`nav-item text-dark ${lastSegment === 'faq' ? 'active' : ''}`}>
                        ...
                        <div
                            id="faq"
                            className={`collapse ${openMenu === 'faq' ? 'show' : ''}`}
                            aria-labelledby="headingFaq"
                        >
                            <div className="bg-white py-2 collapse-inner rounded">
                                <Link className="collapse-item" to="/faqs">Add FAQ</Link>
                                <Link className="collapse-item" to="/faqs/list">FAQ List</Link>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className={`nav-item text-dark ${lastSegment === 'team' ? 'active' : ''}`}>
                        ...
                        <div
                            id="team"
                            className={`collapse ${openMenu === 'team' ? 'show' : ''}`}
                            aria-labelledby="headingFaq"
                        >
                            <div className="bg-white py-2 collapse-inner rounded">
                                <Link className="collapse-item" to="/ourteam/add">Add Team</Link>
                                <Link className="collapse-item" to="/ourteam">List Team</Link>
                            </div>
                        </div>
                    </li>
